...
df_oline = merge_and_fill_na(
    df_oline, dfcbsoline[["team", "cbsolinerank"]], "team", "left"
)
...
df_players = merge_and_fill_na(
    dfplayer, df_oline[["team", "olinerank"]], "team", "left"
)
...
df_players["playerscore"] = (
    df_players["adp"] + df_players["olinerank"] + df_players["sosrank"]
)
