...
df = pd.read_csv(
    "Fangraphs Leaderboard (1).csv", index_col=["playerid"]
)  # 30 IP Pitchers
...
finalSP.to_excel("pitchingSP30ip.xlsx", sheet_name="StartersSeason")
finalRP.to_excel("pitchingRP30ip.xlsx", sheet_name="RelieversSeason")
